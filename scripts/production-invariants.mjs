...
assert(mappers.includes('crypto.randomUUID') && mappers.includes('getRandomValues') && mappers.includes("return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'"), 'UUID fallback remains valid for Supabase UUID columns.');
